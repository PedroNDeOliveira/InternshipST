...
#define VDx941_EXPOSURE_MARGIN                                100
...
static const struct vdx941_rect vdx941_supported_modes[] = {
  ...
  /* VDx941_RES_FULL43_2560_1920 */
  {
    .left = VDx941_COMPUTE_LEFT(2560),
    .top = VDx941_COMPUTE_TOP(1920),
    .width = 2560,
    .height = 1920,
  },
...
int VDx941_GetExposureRange(VDx941_Ctx_t *ctx, unsigned int *min_us, unsigned int *max_us)
{
  uint16_t frame_length;
  int ret;
  ...
  case VDx941_GS_SS32_MONO_8:
  case VDx941_GS_SS32_MONO_10:
    *min_us = (4 * VDx941_LINE_TIME_IN_NS) / 1000;
    break;
  case VDx941_RS_SDR_NATIVE_8:
  case VDx941_RS_SDR_NATIVE_10:
  case VDx941_RS_SDR_NATIVE_12:
  ...
  case VD1941_RS_HDR_RGB_10:
  case VD1941_RS_HDR_RGB_12:
    *min_us = (2 * VDx941_LINE_TIME_IN_NS) / 1000;
    break;
  default:
    return -1;
  }
  ...
  ret = VDx941_ComputeFrameLength(ctx, ctx->ctx.config_save.frame_rate, &frame_length);
  if (ret)
    return ret;
  *max_us = (frame_length - VDx941_EXPOSURE_MARGIN) * VDx941_LINE_TIME_IN_NS / 1000;
...
int VDx941_GetPixelDepth(VDx941_Ctx_t *ctx, unsigned int *pixel_depth)
{
  switch (ctx->ctx.config_save.image_processing_mode) {
  case VDx941_GS_SS1_NATIVE_8:
  case VDx941_GS_SS1_SPLIT_NATIVE_8:
