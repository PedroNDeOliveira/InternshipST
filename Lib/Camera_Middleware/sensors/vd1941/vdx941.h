 ...
 * 16/(16 - again_reg), with again_reg in the range [0, 12] */
 #define VDx941_ANALOG_GAIN_MIN                           0
 ...
 * which corresponds to sensor values in the range [0x0100, 0x2000] */
 #define VDx941_DIGITAL_GAIN_MIN                          0x100
 #define VDx941_DIGITAL_GAIN_MAX                          0x2000
...
/* Again valid in [VDx941_ANALOG_GAIN_MIN .. VDx941_ANALOG_GAIN_MAX] */
int VDx941_SetAnalogGain(VDx941_Ctx_t *ctx, unsigned int gain);
int VDx941_GetAnalogGain(VDx941_Ctx_t *ctx, unsigned int *gain);
/* Again valid in [VDx941_DIGITAL_GAIN_MIN .. VDx941_DIGITAL_GAIN_MAX] */
