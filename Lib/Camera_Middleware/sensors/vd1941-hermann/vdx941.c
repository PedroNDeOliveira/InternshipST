...
static int VDx941_SetupLineLen(VDx941_Ctx_t *ctx)
{
  ...
  // HPI LINE_LENGTH
#if defined(CONF_30FPS_1300MBPS)
  line_length = 5188; // (5436) 1300Mbps	30fps
#elif defined(CONF_30FPS_900MBPS)
  line_length = 7425; // 900Mbps	30fps
#elif defined(CONF_25FPS_1300MBPS)
  line_length = 5188; // 1300Mbps	25fps
#elif defined(CONF_25FPS_900MBPS)
  line_length = 7425; // 900Mbps	25fps
#elif defined(CONF_25FPS_600MBPS)
  line_length = 11059; // 600Mbps	25fps
#else
...
static int VDx941_ComputeFrameLength(VDx941_Ctx_t *ctx, int fps, uint16_t *frame_length)
{
  ...
  *frame_length = MIN(MAX(min_frame_length, req_frame_length), 65535);
  ...
  // HPI
#if defined(CONF_30FPS_1300MBPS)
  *frame_length = 2410; // (2299) 1300Mbps	30fps
#elif defined(CONF_30FPS_900MBPS)
  *frame_length = 1684; // 900Mbps	30fps
#elif defined(CONF_25FPS_1300MBPS)
  *frame_length = 2892; // 1300Mbps	25fps
#elif defined(CONF_25FPS_900MBPS)
  *frame_length = 2021; // 900Mbps	25fps
#elif defined(CONF_25FPS_600MBPS)
  *frame_length = 1357; // 600Mbps	25fps
#else
ERROR: missing FPS and DATARATE selection in app_new_specific_config.h
#endif
